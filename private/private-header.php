<?php
if($_SESSION['status'] != "admin" && $_SESSION['status'] != "SUPER" ){
  ...
  <nav class="navbar navbar-default navbar-static-top" style="padding-top:10px; padding-bottom:10px; background-color:#222222; margin-bottom: 0px; position:fixed; width :100%;">
   <div class"container">
     <div class="navbar-header">
       ...
       <a class="navbar-brand" href="../private/PrivateHome.php" style="font-size:350%;">Strandgaper</a><div style="float:down; color:white; padding-left:20px; "><?php echo $_SESSION['gebruikersnaam'];?></div>
     </div>
     <div class="collapse navbar-collapse" id="mynavbar">
       ...
       <ul class="nav navbar-nav" style="font-size:130%; ">
         <li><a href="../private/bericht.php">Berichten</a></li>
       </ul>
       <ul class="nav navbar-nav" style="font-size:130%; ">
         <li><a href="../private/Account.php">Account</a></li>
       </ul>
       <ul class="nav navbar-nav" style="font-size:130%; ">
         <li><a href="../private/Statistieken.php">Statistieken</a></li>
       </ul>
       <ul class="nav navbar-nav" style="font-size:130%; ">
         <li><a href="../private/Beschikbaarheid.php">Beschikbaarheid</a></li>
       </ul>
       <ul class="nav navbar-nav" style="font-size:130%; ">
         <li><a href="../private/ToDo.php">To Do list</a></li>
       </ul>
       <?php if($_SESSION['status']!="SUPER"){}else{
         echo"<ul class='nav navbar-nav' style='font-size:130%; '>
           <li><a href='../private/gebruikers.php'>Gebruikers</a></li>
         </ul>"; }; ?>
