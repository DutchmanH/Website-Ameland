<?php session_start(); ?>
<?php require("../user/user-header.php"); ?>
<!DOCTYPE html>
<html>
  <head>
    <title> Strandgaper Ameland - Gebruiker Home</title>
...
<body>
  <div class="contrainer-fluid">
    ...
    <div class="row">
      ...
      <div style="text-align: center; font-size:400%; border-top: solid #222222 30px; margin-bottom:20px;"><b>Strandgaper-Gebruiker</b></div>
    </div>
